                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="row">
                                                                <div class="col-md">
                                                                    <a href="{{ route('user-edit', $data->id) }}" aria-placeholder="Edit">
                                                                        <i class="nav-icon fas fa-edit" style="color: green;"></i>
                                                                    </a>
                                                                    <a href="{{ route('user-delete', $data->id) }}" aria-placeholder="Delete" onclick="return confirm('Are you sure you want to delete this item?');">
