                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>                                                
                                                        ...
                                                        <td>
                                                            <div class="row">
                                                                <div class="col-md">
                                                                    <a href="{{ route('laboratorium-edit', $data->id_lab) }}" aria-placeholder="Edit">
                                                                        <i class="nav-icon fas fa-edit" style="color: green;"></i>
                                                                    </a>
                                                                    <a href="{{ route('laboratorium-delete', $data->id_lab) }}" aria-placeholder="Delete" onclick="return confirm('Are you sure you want to delete this item?');">
...
@push('scripts')
    ...
    <script>
        document.querySelector('.tambah-button').addEventListener('click', function() {
            window.location.href = "{{ route('laboratorium-create') }}";
        });
