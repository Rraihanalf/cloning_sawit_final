                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>                                                
                                                        ...
                                                        <td>
                                                            <div class="row">
                                                                <div class="col-md">
                                                                    <a href="{{ route('pegawai-edit', $data->id_pegawai) }}" aria-placeholder="Edit">
                                                                        <i class="nav-icon fas fa-edit" style="color: green;"></i>
                                                                    </a>
                                                                    <a href="{{ route('pegawai-delete', $data->id_pegawai) }}" aria-placeholder="Delete" onclick="return confirm('Are you sure you want to delete this item?');">
